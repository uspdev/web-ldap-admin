...
;(function ( $, window, document, undefined ) {
    ...
    Plugin.prototype._create = function () {
        ...
        this.element.append(
            ...
            <h4>A senha deve incluir:</h4> \
            <ul> \
            <li data-criterion="length" class="valid">De 8 à 20 <strong>caracteres</strong></li> \
    ...
    Plugin.prototype._update_indicator = function(total) {
        ...
        if (total === 0) {
            ...
            meter.addClass('veryweak').html('<p>Muito fraca</p>');
        } else if (total === 2) {
            meter.addClass('weak').html('<p>Fraca</p>');
        } else if (total === 3) {
            meter.addClass('medium').html('<p>Média</p>');
        } else {
            meter.addClass('strong').html('<p>Forte</p>');
        }
    },
